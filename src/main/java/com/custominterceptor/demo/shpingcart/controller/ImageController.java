...
import com.custominterceptor.demo.shpingcart.service.image.ImageService;
...
public class ImageController {
    ...
    {
        try{
            var imageList = imageService.saveImage(files, productId);
            System.err.println("productId"+ productId);
            return ResponseEntity.ok(new ApiResponse("Upload Success", imageList));
